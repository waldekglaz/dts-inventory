...
import { addMaterial } from '@/app/materials/actions';
            ...
            <form ref={formRef} action={async (formData) => {
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem', marginBottom: '1.5rem' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        <label style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Material Name</label>
                        <input name="name" required placeholder="e.g., Steel Sheet 2mm"
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        ...
                        <select name="unit" style={{ background: 'var(--bg-panel)', border: '1px solid var(--border-subtle)', padding: '0.6rem', borderRadius: '6px', color: 'white' }}>
